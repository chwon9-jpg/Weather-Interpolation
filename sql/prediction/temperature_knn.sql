...
-- QUERY: raw k nearest neighbours
-- Returns the k=5 nearest training points to a target location at a given hour.
...
-- QUERY: IDW predicted temperature
WITH neighbours AS (
    SELECT
        wo.temperature,
        GREATEST(
...
-- QUERY: batch evaluation — MAE & RMSE across all test zones
